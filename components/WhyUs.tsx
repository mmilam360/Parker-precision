        ...
        <div className="mt-10 grid sm:mt-14 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {stats.map((item) => {
            ...
            return (
              <div
                key={item.label}
                className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 text-center backdrop-blur-sm transition-all duration-300 hover:border-[#990000]/40 hover:bg-white/[0.08] hover:-translate-y-1 sm:p-8"
              >
